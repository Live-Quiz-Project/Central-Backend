...
VALUES
	...
	(uuid_generate_v4(), (SELECT id FROM "live_quiz_session" WHERE status = 'active'), (SELECT id FROM "participant" WHERE name = 'Participant 2'), 'SHORT_TEXT', (SELECT id FROM "question_history" WHERE quiz_id = '865bf37f-5447-47de-b0d5-56adb0f682d6' AND "order" = 3 ),'went<!#XyZ@?>bus', 5, NOW(), NOW()),
...
VALUES
	...
	(uuid_generate_v4(), (SELECT id FROM "live_quiz_session" WHERE status = 'active'), (SELECT id FROM "participant" WHERE name = 'Participant 3'), 'SHORT_TEXT', (SELECT id FROM "question_history" WHERE quiz_id = '865bf37f-5447-47de-b0d5-56adb0f682d6' AND "order" = 3 ), 'go<!#XyZ@?>bus', 4 , NOW(), NOW()),
